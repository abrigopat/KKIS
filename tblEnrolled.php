                    ...
                    <table class="table table-stripped table-bordered dataTable responsive display nowrap no-footer dtr-inline collapsed printTable" role="grid" cellspacing="0" id="kabataanTbl" style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <!-- Kabataan Modal -->
                                <div class="modal" role="dialog" tabindex="1" id="viewMore<?php echo $enrolled["resident_id"]; ?>">
                                        ...
                                        <div class="modal-content" id="modalContentID">
                                            ...
                                            <div class="row mx-3 px-3" width="100%" height="100%" style="border: 1px solid #aeaeae; border-radius: 20px;">
                                                ...
                                                <div class="col-md-8 col-12 d-flex align-items-center">
                                                    <div>
                                                        <span class="basicTxt w-100 my-1" id="nameTxt"><?php echo $enrolled["full_name"]; ?></span>
                                                        <br>
                                                        <span class="basicTxt w-100 my-1 mt-2" id="ageGender"><?php echo $enrolled["age"] . " YEARS OLD, " . $enrolled["gender_preference"]; ?></span>
                                                        <br>
                                                        <span class="basicTxt w-100 my-1" id="purok"><?php echo $enrolled["purok"]; ?></span>
                                                    </div>
                                                </div>
                                                <!-- QR Code -->
                                                <div class="col-12 col-md-4 d-flex justify-content-md-end justify-content-center">
                                                    <img class="rounded-2" src="<?php echo $enrolled["qr_code"]; ?>" width="200px" height="auto">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mx-3 px-3 my-5" width="100%" height="auto" style="border: 1px solid #aeaeae; border-radius: 20px;">
                                                ...
                                                <div class="col-md-4 col-6">
                                                    <p class="textRetrieved" id="textRetrievedID"><?php echo $enrolled["remarks"]; ?></p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col" id="row2Body">
                                                    <div class="row gy-1" id="row4Content">
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="col col-12" id="row4ContentDiv">
                                                                <label class="form-label modalLabel">Remarks:</label>
                                                                <p class="textRetrieved" id="textRetrievedID1"><?php echo $enrolled["remarks"]; ?></p>
                                                            </div>
                                                            <div class="col col-12" id="row4ContentDiv">
