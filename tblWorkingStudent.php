                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td id="school_type" class="entryRow" scope="col" data-label="School Type"><?php echo $workingStudent["remarks"]; ?></td>
                                ...
                                <!-- Kabataan Modal -->
                                <div class="modal" role="dialog" tabindex="1" id="viewMore<?php echo $workingStudent["resident_id"]; ?>">
                                        ...
                                        <div class="modal-content" id="modalContentID">
                                            ...
                                            <div class="row mx-3 px-3" width="100%" height="100%" style="border: 1px solid #aeaeae; border-radius: 20px;">
                                                ...
                                                <div class="col-md-8 col-12 d-flex align-items-center">
                                                    <div>
                                                        <span class="basicTxt w-100 my-1" id="nameTxt"><?php echo $workingStudent["full_name"]; ?></span>
                                                        <br>
                                                        <span class="basicTxt w-100 my-1 mt-2" id="ageGender"><?php echo $workingStudent["age"] . " YEARS OLD, " . $workingStudent["gender_preference"]; ?></span>
                                                        <br>
                                                        <span class="basicTxt w-100 my-1" id="purok"><?php echo$workingStudent["purok"]; ?></span>
                                                    </div>
                                                </div>
                                                <!-- QR Code -->
                                                <div class="col-12 col-md-4 d-flex justify-content-md-end justify-content-center">
                                                    <img class="rounded-2" src="<?php echo $workingStudent["qr_code"]; ?>" width="200px" height="auto">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mx-3 px-3 my-5" width="100%" height="auto" style="border: 1px solid #aeaeae; border-radius: 20px;">
                                                ...
                                                <div class="col-md-4 col-6">
                                                    <p class="textRetrieved" id="textRetrievedID"><?php echo $workingStudent["remarks"]; ?></p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col" id="row2Body">
                                                    <div class="row gy-1" id="row4Content">
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="col col-12" id="row4ContentDiv">
                                                                <label class="form-label modalLabel">Remarks:</label>
                                                                <p class="textRetrieved" id="textRetrievedID1"><?php echo $workingStudent["remarks"]; ?></p>
                                                            </div>
                                                            <div class="col col-12" id="row4ContentDiv">
