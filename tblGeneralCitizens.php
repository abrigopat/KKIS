...
$queryGeneralCitizens = "SELECT *, CONCAT(`last_name`, ', ', `first_name`, ' ', `middle_name`) AS  full_name, DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 AS `age` FROM `residents` WHERE DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 NOT BETWEEN 15 AND 30 "; //query to select all data from table
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td id="remarks" class="entryRow" scope="col" data-label="Remarks"><?php echo $generalCitizens["remarks"]; ?></td>
                                ...
                                <!-- Kabataan Modal -->
                                <div class="modal" role="dialog" tabindex="1" id="viewMore<?php echo $generalCitizens["resident_id"]; ?>">
                                        ...
                                        <div class="modal-content" id="modalContentID">
                                            ...
                                            <div class="row mx-3 px-3" width="100%" height="100%" style="border: 1px solid #aeaeae; border-radius: 20px;">
                                                ...
                                                <div class="col-md-8 col-12 d-flex align-items-center">
                                                    <div>
                                                        <span class="basicTxt w-100 my-1" id="nameTxt"><?php echo $generalCitizens["full_name"]; ?></span>
                                                        <br>
                                                        <span class="basicTxt w-100 my-1 mt-2" id="ageGender"><?php echo $generalCitizens["age"] . " YEARS OLD, " . $generalCitizens["gender_preference"]; ?></span>
                                                        <br>
                                                        <span class="basicTxt w-100 my-1" id="purok"><?php echo $generalCitizens["purok"]; ?></span>
                                                    </div>
                                                </div>
                                                <!-- QR Code -->
                                                <div class="col-12 col-md-4 d-flex justify-content-md-end justify-content-center">
                                                    <img class="rounded-2" src="<?php echo $generalCitizens["qr_code"]; ?>" width="200px" height="auto">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mx-3 px-3 my-5" width="100%" height="auto" style="border: 1px solid #aeaeae; border-radius: 20px;">
                                                ...
                                                <div class="col-md-4 col-6">
                                                    <p class="textRetrieved" id="textRetrievedID"><?php echo $generalCitizens["remarks"]; ?></p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col" id="row2Body">
                                                    <div class="row gy-1" id="row4Content">
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="col col-12" id="row4ContentDiv">
                                                                <label class="form-label modalLabel">Remarks:</label>
                                                                <p class="textRetrieved" id="textRetrievedID1"><?php echo $generalCitizens["remarks"]; ?></p>
                                                            </div>
                                                            <div class="col col-12" id="row4ContentDiv">
