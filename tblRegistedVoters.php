...
$queryRegisteredVoter= "SELECT * FROM `residents` WHERE `voter_type` = 'Registered'";
$resultRegisteredVoter = executeQuery($queryRegisteredVoter);
?>
                ...
                <div class="sectionDiv mx-0 mt-4" id="sectionKabataan">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            while ($rowRegisteredVoter = mysqli_fetch_array($resultRegisteredVoter)) {
                                echo '
                                
                                <tr>
                                        <td class="entryRow" scope="col" data-label="Name">' . $rowRegisteredVoter['last_name'] . ' ' . $rowRegisteredVoter['first_name'] . ' ' . $rowRegisteredVoter['middle_name'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Gender">' . $rowRegisteredVoter['gender_preference'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Age">' . $rowRegisteredVoter['age'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Birthday">' . $rowRegisteredVoter['birthday'] . '</td>
                                        <td class="entryRow" scope="col" data-label=Marital Status"">' . $rowRegisteredVoter['marital_status'] . '</td>
                                        <td class="entryRow" scope="col" data-label="ContactNo.">' . $rowRegisteredVoter['contact_no'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Purok">' . $rowRegisteredVoter['purok'] . '</td>
                                        <td class="entryRow text-center" scope="col" data-label="Actions">
                                            <div class="row gy-2 mx-0" height="100%">
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-warning actionBtn" role="button" data-bs-toggle="modal" data-bs-target="#viewMore' . $rowRegisteredVoter['resident_id'] . '" data-id="' . $rowRegisteredVoter['rencrypted_id'] . '" href="#viewMore"><i class="fa-regular fa-eye"></i></a> 
                                                </div>
                                            
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-primary actionBtn" href="updateEntry.php?residentID=' . $rowRegisteredVoter['rencrypted_id'] . 'role="button" aria-pressed="true"><i class="fa-solid fa-pen"></i></a>
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    ...
                                                    if ($("#deleteEntry").click(function(){
                                                        Swal.fire({
                                                            icon: "warning",
                                                            title: "Are you sure?",
                                                            text: "Deleting"' . $rowRegisteredVoter['last_name'] . ' ' . $rowRegisteredVoter['first_name'] . ' ' . $rowRegisteredVoter['middle_name'] . '" will completely remove this record.",
                                                        }).then((result) => {
